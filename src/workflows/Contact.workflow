...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Unsubscribe_from_Pila_bulletin</fullName>
        <description>When VR changes the unsubscribe field, uncheck the receives PILA bulletin box</description>
        <field>Receives_PILA_bulletin__c</field>
        <literalValue>0</literalValue>
        <name>Unsubscribe from Pila bulletin</name>
